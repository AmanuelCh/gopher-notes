...
Go follows the [printf tradition](https://cplusplus.com/reference/cstdio/printf/) from the C language. Honestly speaking, string formatting/interpolation in Go is currently *less* elegant than JavaScript and Python

- [fmt.Printf](https://pkg.go.dev/fmt#Printf) - Prints a formatted string to [standard output](https://stackoverflow.com/questions/3385201/confused-about-stdin-stdout-and-stderr).
